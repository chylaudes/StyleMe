$(document).ready(function () {
 ...
 if (detailsDiv.find("#access_2Id").length !== 0)
  ...
  if (dressId !== undefined && dressId !== null) {
    var modalDressURL = "https://api.shopstyle.com/api/v2/products/"+dressId+"?pid=uid2100-27524390-36";
  ...
  if (topId !== undefined && topId !== null) {
    var modalTopURL = "https://api.shopstyle.com/api/v2/products/"+topId+"?pid=uid2100-27524390-36";
  ...
  if (bottomId !== undefined && bottomId !== null) {
    var modalBottomURL = "https://api.shopstyle.com/api/v2/products/"+bottomId+"?pid=uid2100-27524390-36";
  ...
  if (shoeId !== undefined && shoeId !== null) {
    var modalShoeURL = "https://api.shopstyle.com/api/v2/products/"+shoeId+"?pid=uid2100-27524390-36";
  ...
  if (access_1Id !== undefined && access_1Id !== null) {
    var modalAccess1URL = "https://api.shopstyle.com/api/v2/products/"+access_1Id+"?pid=uid2100-27524390-36";
  ...
  if (access_2Id !== undefined && access_2Id !== null) {
    var modalAccess2URL = "https://api.shopstyle.com/api/v2/products/"+access_2Id+"?pid=uid2100-27524390-36";
